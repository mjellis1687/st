...
- [externalpipe](https://st.suckless.org/patches/externalpipe/) via [patch](https://st.suckless.org/patches/externalpipe/st-externalpipe-0.8.5.diff): Reading and writing st's screen through a pipe.
